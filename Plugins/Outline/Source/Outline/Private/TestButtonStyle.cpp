...
TSharedPtr< FSlateStyleSet > FTestButtonStyle::StyleInstance = NULL;
...
TSharedRef< FSlateStyleSet > FTestButtonStyle::Create()
{
	...
	Style->SetContentRoot(IPluginManager::Get().FindPlugin("Outline")->GetBaseDir() / TEXT("Resources"));

	Style->Set("Outline.PluginAction", new IMAGE_BRUSH(TEXT("ButtonIcon_40x"), Icon40x40));
